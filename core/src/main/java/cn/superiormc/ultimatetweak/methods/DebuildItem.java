...
public class DebuildItem {
    ...
    public static ConfigurationSection debuildItem(ItemStack itemStack, ConfigurationSection section) {
        ...
        if (UltimateTweak.methodUtil.methodID().equals("paper") &&
            ...
            section.set("component", UltimateTweak.methodUtil.serializeItemStack(itemStack));
        } else {
            ...
            if (meta.hasDisplayName()) {
                section.set("name", UltimateTweak.methodUtil.getItemName(meta));
            }

            // Item Name
            if (CommonUtil.getMinorVersion(20, 5)) {
                if (meta.hasItemName()) {
                    section.set("item-name", UltimateTweak.methodUtil.getItemItemName(meta));
                }
            }

            // Lore
            if (meta.hasLore()) {
                section.set("lore", UltimateTweak.methodUtil.getItemLore(meta));
            }
            ...
            if (meta instanceof SkullMeta) {
                ...
                String textureValue = UltimateTweak.methodUtil.serializeSkull(skullMeta);
