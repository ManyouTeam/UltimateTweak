package cn.superiormc.ultimatetweak.methods;
...
import cn.superiormc.ultimatetweak.utils.NBTUtil;
    ...
    public static ItemStack editItemStack(ItemStack item,
        ...
        if (materialKey != null) {
            ...
            if (pluginName != null && itemID != null) {
                ...
                item = UltimateTweak.methodUtil.getItemObject(itemThing);
            }
        }
        ...
        if (displayNameKey != null) {
            UltimateTweak.methodUtil.setItemName(meta, CommonUtil.modifyString(player, displayNameKey, args), player);
        }
        ...
        if (CommonUtil.getMinorVersion(20, 5)) {
            ...
            if (itemNameKey != null) {
                UltimateTweak.methodUtil.setItemItemName(meta, CommonUtil.modifyString(player, itemNameKey, args), player);
            }
        }
        ...
        if (!lores.isEmpty()) {
            UltimateTweak.methodUtil.setItemLore(meta, CommonUtil.modifyList(player, lores, args), player);
        }
        ...
        if (meta instanceof SkullMeta) {
            ...
            if (skullTextureNameKey != null) {
                ...
                if (skullTextureNameKey.length() > 16) {
                    UltimateTweak.methodUtil.setSkullMeta(skullMeta, skullTextureNameKey);
                } else {
        ...
        if (meta instanceof BlockStateMeta) {
            ...
            if (state instanceof CreatureSpawner) {
                ...
                if (spawnerKey != null) {
                    ...
                    if (UltimateTweak.methodUtil.methodID().equals("paper") && CommonUtil.getMinorVersion(20, 5) && entityType == EntityType.ITEM) {
        ...
        if (componentKey != null) {
            item = UltimateTweak.methodUtil.editItemStack(item, player, componentKey, -1, args);
        }
