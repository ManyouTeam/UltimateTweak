...
public class LanguageManager {
    ...
    private void initLanguages() {
        File langFolder = new File(UltimateTweak.instance.getDataFolder(), "languages");
    ...
    private String getMessage(Player player, String key, String... args) {
        ...
        text = text.replace("{plugin_folder}", String.valueOf(UltimateTweak.instance.getDataFolder()));
        return text;
    }

    private void saveLanguageFile(String lang, YamlConfiguration config) {
        File file = new File(UltimateTweak.instance.getDataFolder(), "languages/" + lang + ".yml");
        try {
            config.save(file);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private YamlConfiguration loadInternalLanguage(String language) {
        ...
        InputStream inputStream = UltimateTweak.instance.getResource("languages/" + resourceName + ".yml");
        if (inputStream == null) {
            return null;
        }
